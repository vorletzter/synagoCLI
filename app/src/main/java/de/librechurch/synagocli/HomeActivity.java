...
public class HomeActivity extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        */
        FloatingActionButton newRoom = (FloatingActionButton) findViewById(R.id.fab);
        newRoom.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Snackbar.make(view, "toDO: New Room", Snackbar.LENGTH_LONG)
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        } else if (id == R.id.nav_matrix_contacts) {
